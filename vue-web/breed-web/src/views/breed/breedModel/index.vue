  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="revenueTable"
        ...
        <el-table-column label="基料信息" align="center">
          ...
          <template slot-scope="scope">
            <el-row>
              <el-button
                size="mini"
                type="text"
                @click="handleUpdateModel(scope.$index, scope.row)">编辑
              </el-button>
              <el-button size="mini"
                         type="text"
...
<script>
import {fetchList, deleteBreedModel} from '@/api/breedModel';
...
export default {
  ...
  methods: {
    ...
    /**跳转添加 **/
    handleAddBreedModel() {
      this.$router.push('/breed/addBreedModel');
    },
    /**跳转编辑 **/
    handleUpdateModel(index, row) {
      this.$router.push({path: '/breed/updateBreedModel', query: {id: row.bmId}});
    },
    ...
    handleDelete(index, row) {
      this.$confirm('是否要删除该模式?', '提示', {
        ...
        console.log();
        deleteBreedModel(row.bmId).then(response => {
          this.$message({
            type: 'success',
            message: '删除成功!'
          });
