  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="animalDisease"
      ...
      <el-form-item label="病因：" prop="animalDisease" isEdit>
        <quill-editor v-model="animalDisease.pathogeny" :options="quillOption">
        </quill-editor>
      </el-form-item>
      <el-form-item label="症状" prop="animalDisease" isEdit>
        <quill-editor v-model="animalDisease.symptom" :options="quillOption"></quill-editor>
      </el-form-item>
      <el-form-item label="治疗方法" prop="animalDisease" isEdit>
        <quill-editor v-model="animalDisease.treatment" :options="quillOption"></quill-editor>
      </el-form-item>
